class Rational {
public:
  // see item24 for why this ctor isn't declared explicit
...
friend
  const Rational                     	// see Item 3 for why
...
inline const Rational& operator*(const Rational& lhs, const Rational& rhs)
{
  ...
  return result;	// this local object will be destoryed when the function exits
}
*/
